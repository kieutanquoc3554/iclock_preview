...
const Security = () => {
  return (
    <div className="security-container">
      <p className="title">Chính sách bảo mật</p>
      ...
      <p>
        ...
        cung cấp dịch vụ, bao gồm một số thông tin cá nhân: danh hiệu, tên, giới
      ...
      <p>
        ...
        của bạn; xác minh và thực hiện giao dịch trực tuyến, nhận diện khách vào
      ...
      <p>
        ...
        Tại đây, quý khách sẽ thấy chi tiết đơn đặt hàng của mình, những sản
        phẩm đã nhận và những sản phẩm đã gửi và chi tiết email, ngân hàng và
        bản tin mà bạn đặt theo dõi dài hạn.
      </p>
      <p>
      ...
      <p>
        ...
        Quý khách có thể từ chối không tham gia bất cứ lúc nào.
      </p>
      <p>
      ...
      <p>
        ...
        động nào nhằm can thiệp, phá hoại hay xâm nhập vào dữ liệu của hệ thống
      ...
      <p>
        <strong>4. Phạm vi thu thập thông tin</strong>
      </p>
      <p>Chúng tôi thu thập thông tin cá nhân của bạn khi: </p>
      <p>
        Bạn trực tiếp cung cấp cho chúng tôi. Đó là các thông tin cá nhân bạn
        cung cấp cho chúng tôi được thực hiện chủ yếu trên website của iClock
        bao gồm: họ tên, địa chỉ thư điện tử (email), số điện thoại, địa chỉ,
        thông tin đăng nhập tài khoản bao gồm thông tin bất kỳ cần thiết để
        thiết lập tài khoản ví dụ như tên đăng nhập, mật khẩu đăng nhập, ID/địa
        chỉ đăng nhập.
      </p>
      <p>
        <strong>5. Thời gian lưu trữ</strong>
      </p>
      <p>
        Thông tin cá nhân của khách hàng sẽ được lưu trữ cho đến khi khách hàng
        có yêu cầu hủy bỏ hoặc khách hàng tự đăng nhập và thực hiện hủy bỏ.
        Trong mọi trường hợp thông tin cá nhân của khách hàng sẽ được bảo mật
        trên máy chủ của iClock
      </p>
    </div>
  );
};
